...
- request_scoped_not_module_global (1, security-relevant → applied early) → a1-new-feature/workflows/04-plan.md ("Request-scoped state" subsection), agents/a1-pablo-planner.md (decomposition step 6), agents/a1-erik-executor.md (step 3c-ter) [2026-07-04, M6 Task 1.2] — module-global injected state (writer/handler) leaks across concurrent requests on Fluid Compute; state must be request-scoped.
